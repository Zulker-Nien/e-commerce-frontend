...
const CartSlider = () => {
  ...
  const { setCartIsInactive, cartItems, cartIsActive, handleRemoveCartItem } =
    store;

  console.log(cartItems);
  const [cartItem, setCartItem] = useState<CategoryProps[]>(
          ...
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            <div className="pointer-events-auto w-screen max-w-md">
              <motion.div
                ...
                animate={cartIsActive ? "show" : "hide"}
                initial="hide"
                    ...
                    <div className="flow-root">
                      ...
                      >
                        {Array.isArray(cartItem) &&
                          cartItem.map((item) => {
                            const itemCount = cartItem.filter(
...
export default observer(CartSlider);
